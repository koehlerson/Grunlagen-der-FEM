...
!.....compute entries of the elacticity matrix
      ...
      subroutine bmat03(nel,shp,bmat)
!--------------------------------------------------------------------72
...
!                            shp(2,*) -> N,y
!                            shp(3,*) -> N 
      real*8 bmat(3,6)   ! b-operator matrix at current gauss point
!     internal parameters
...
!.....compute entries of the b-operator matrix
      ...
      subroutine kemat03(s,bmat,aa,detj,wg,nst)
!----------------------------------------------------------------------      
...
!.........get gauss point coordinate and weighting factor
          call gauss03(l,lint,eg,wg)
! 
!.........compute shape function at current gauss point
          call shape03(nel,eg,xl,shp,detj)
! 
!.........compute b-matrix at current gauss point 
          call bmat03(nel,shp,bmat)
!             
!.........compute element stiffness at current gauss point
          call kemat03(s,bmat,aa,detj,wg,nst)
...
!----------------------------------------------------------------------    
      ...
      subroutine gauss03(l,lint,eg,wg)
!----------------------------------------------------------------------
!     computes weighting factors ans positions of (t1/t2) gausspoints
!----------------------------------------------------------------------
      implicit none
!.....input
      integer lint      ! number of gauss points
...
!.....t1 gausspoint coordinates and weight factors
      ...
      subroutine shape03(nel,eg,xl,shp,detj)
!----------------------------------------------------------------------
!     computes ansatz functions for t1/t2 elements
!----------------------------------------------------------------------
      implicit none
!.....input
      integer nel        ! nodes per element 
      real*8 eg(2)      ! l-th gauss point coordinates (l=1,...,lint) 
