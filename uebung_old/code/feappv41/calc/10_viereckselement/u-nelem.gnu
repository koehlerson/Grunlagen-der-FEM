...
plot "u-nelem_t1.dat" using 1:2 w lp ls 1 title "t1 (diagonal)",\
 "u-nelem_t1_cross.dat" using 1:2 w lp ls 2 title "t1 (cross pattern)",\
 "u-nelem_t2.dat" using 1:2 w lp ls 3 title "t2 (diagonal)" ,\
 "u-nelem_q1.dat" using 1:2 w lp ls 4 title "q1" ,\
 "u-nelem_q2.dat" using 1:2 w lp ls 5 title "q2"
