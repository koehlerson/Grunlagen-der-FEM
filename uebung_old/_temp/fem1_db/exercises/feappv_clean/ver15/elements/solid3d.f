...
c         Compute stress at point
          ...
          call modlsd(d,ta,eps,hr(nh1+nn),hr(nh2+nn),nhv,dd,sig,isw)
...
c       Compute stress at point
        ...
        call modlsd(d,ta,eps,hr(nh1+nn),hr(nh2+nn),nhv,dd,sig, 8)
