...
# ╔═╡ 44e319ae-12d9-11eb-00a8-6dfa1e52dec3
md"
# Grundlagen der FEM
Wilkommen in der ersten Übung im Modul Grundlagen der FEM. In dieser ersten Übung werden wir uns um grundlegende Konzepte innerhalb Julia, Pluto Notebooks und Tensoren beschäftigen
## Übung 1
"
...
md"### Packages
Natürlich müssen wir nicht bei jedem Problem von null anfangen und das Rad neu erfinden. Viele Menschen überall auf der Welt kreieren ein Ökosystem für wissenschaftliches Rechnen innerhalb Julia. Einzelne Funktionen und Verbunde (engl. Structs) werden zusammen gefasst in Packages"
